        ...
        <div class="ws_hint" id="<?php echo esc_attr($hint_id); ?>">
            ...
            <div class="ws_hint_content">
                ...
                <ul>
                    ...
                    <li>You can now use "not:user:username", "capability1,capability2", "capability1+capability2"
                        and other
                        advanced syntax in the capability field. See the link above for details.
                    </li>

                    <li>You can drag sub-menu items to the top level and the other way around. To do it,
                        drag the item to the very end of the (sub-)menu and drop it on the yellow rectangle that
                        will appear.
                    </li>

                    <li>Added a "Target page" drop-down to simplify setting menu URLs. You can still enter an
                        arbitrary URL
                        by selecting "Custom".
                    </li>
    ...
    <div id='ws_menu_editor'>
        ...
        <div>
            ...
            <div class='ws_main_container'>
                <div class='ws_toolbar'>
                    <div class="ws_button_container">
                        <a id='ws_cut_menu' class='ws_button' href='javascript:void(0)' title='Cut'><img
                                src='<?php echo $icons['cut']; ?>' alt="Cut"/></a>
                        <a id='ws_copy_menu' class='ws_button' href='javascript:void(0)' title='Copy'><img
                                src='<?php echo $icons['copy']; ?>' alt="Copy"/></a>
                        <a id='ws_paste_menu' class='ws_button' href='javascript:void(0)' title='Paste'><img
                                src='<?php echo $icons['paste']; ?>' alt="Paste"/></a>

                        <div class="ws_separator">&nbsp;</div>

                        <a id='ws_new_menu' class='ws_button' href='javascript:void(0)' title='New menu'><img
                                src='<?php echo $icons['new']; ?>' alt="New menu"/></a>

                        <?php if ($editor_data['show_deprecated_hide_button']): ?>
                            <a id='ws_hide_menu' class='ws_button' href='javascript:void(0)' title='Show/Hide'><img
                                    src='<?php echo $icons['hide']; ?>' alt="Show/Hide"/></a>
                        <?php endif; ?>

                        <a id='ws_delete_menu' class='ws_button' href='javascript:void(0)' title='Delete menu'><img
                                src='<?php echo $icons['delete']; ?>' alt="Delete menu"/></a>

                        <div class="ws_separator">&nbsp;</div>

                        <a id='ws_new_separator' class='ws_button' href='javascript:void(0)'
                           title='New separator'><img src='<?php echo $icons['new-separator']; ?>'
                                                      alt="New separator"/></a>
                        ...
                        <?php if (apply_filters('admin_menu_editor_is_pro', false)): ?>
                            ...
                            <a id='ws_toggle_all_menus' class='ws_button' href='javascript:void(0)'
                               title='Toggle all menus for the selected role'><img
                                    src='<?php echo $icons['toggle-all']; ?>' alt="Toggle all"/></a>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class='ws_main_container'>
                <div class='ws_toolbar'>
                    <div class="ws_button_container">
                        <a id='ws_cut_item' class='ws_button' href='javascript:void(0)' title='Cut'><img
                                src='<?php echo $icons['cut']; ?>' alt="Cut"/></a>
                        <a id='ws_copy_item' class='ws_button' href='javascript:void(0)' title='Copy'><img
                                src='<?php echo $icons['copy']; ?>' alt="Copy"/></a>
                        <a id='ws_paste_item' class='ws_button' href='javascript:void(0)' title='Paste'><img
                                src='<?php echo $icons['paste']; ?>' alt="Paste"/></a>

                        <div class="ws_separator">&nbsp;</div>

                        <a id='ws_new_item' class='ws_button' href='javascript:void(0)' title='New menu item'><img
                                src='<?php echo $icons['new']; ?>' alt="New menu item"/></a>
                        <?php if ($editor_data['show_deprecated_hide_button']): ?>
                            <a id='ws_hide_item' class='ws_button' href='javascript:void(0)' title='Show/Hide'><img
                                    src='<?php echo $icons['hide']; ?>' alt="Show/Hide"/></a>
                        <?php endif; ?>
                        <a id='ws_delete_item' class='ws_button' href='javascript:void(0)' title='Delete menu item'><img
                                src='<?php echo $icons['delete']; ?>' alt="Delete menu item"/></a>

                        <div class="ws_separator">&nbsp;</div>

                        <?php if (apply_filters('admin_menu_editor_is_pro', false)): ?>
                            <a id='ws_new_submenu_separator' class='ws_button' href='javascript:void(0)'
                               title='New separator'><img src='<?php echo $icons['new-separator']; ?>'
                                                          alt="New separator"/></a>
                            <div class="ws_separator">&nbsp;</div>
                        <?php endif; ?>

                        <a id='ws_sort_ascending' class='ws_button' href='javascript:void(0)'
                           title='Sort ascending'>
                            <img src='<?php echo $images_url; ?>/sort_ascending.png' alt="Sort ascending"/>
                        </a>
                        <a id='ws_sort_descending' class='ws_button' href='javascript:void(0)'
            ...
            <div class="ws_basic_container">
                ...
                <div class="ws_main_container" id="ws_editor_sidebar">
                    <form method="post"
                          action="<?php echo admin_url('options-general.php?page=menu_editor&noheader=1'); ?>"
                          id='ws_main_form' name='ws_main_form'>
                        ...
                        <input type="button" id='ws_save_menu' class="button-primary ws_main_button"
                               value="Save Changes"/>
                    </form>
...
<label for="ws-hide-advanced-settings">
	...
	<span>
        ...
        <p>
            You can use a plugin like <a href="http://wordpress.org/plugins/peters-login-redirect/">Peter's Login
                Redirect</a>
