      ...
      <tr>
        <td>
            ...
            <label for="enable_simple_admin_for_multisite">
                <?php esc_html_e('Allow single site administrator access to User Role Editor', 'ure'); ?>
            </label>
        </td>
        <td>             
        </td>
      ...
      <tr>
        <td>
            ...
            <label for="enable_help_links_for_simple_admin_ms">
                <?php esc_html_e('Show help links for single site administrator', 'ure'); ?>
            </label>
        </td>
        <td>
        </td>
      ...
      <tr>
        <td>
            ...
            <label for="enable_unfiltered_html_ms" style="color: red;">
                <?php esc_html_e('Enable "unfiltered_html" capability', 'ure'); ?>
            </label>                        
        </td>
        <td>
<?php
      ...
      <tr>
        <td>
            ...
            <label for="caps_access_restrict_for_simple_admin">
                <?php esc_html_e('Activate access restrictions to User Role Editor for single site administrator', 'ure'); ?>
            </label>
        </td>
        <td>
        </td>
...
?>
      ...
      <tr>
        <td colspan="2">
            ...
            <label for="add_del_role_for_simple_admin" title="<?php esc_html_e('Single site administrator can delete roles with allowed capabilities inside only', 'ure'); ?>">
                <?php esc_html_e('Allow single site administrator Add/Delete roles', 'ure'); ?>
            </label>
        </td>
      </tr>      
      <tr>
          <td colspan="2">            
            <table>
                <tr>
                    <td>
                        <span style="color: red;font-weight: bold;"><?php esc_html_e('Blocked capabilities:', 'ure'); ?></span><br/>
                    ...
                    <td>
                        <span style="color: green;font-weight: bold;"><?php esc_html_e('Allowed capabilities:', 'ure'); ?></span><br/>
