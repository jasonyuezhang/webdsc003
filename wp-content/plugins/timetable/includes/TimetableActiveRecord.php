...
class TimetableActiveRecord
{
  public static function model()
  {
    $instance = new TimetableActiveRecord();
    return $instance;
  }
	 ...
	 *
	 * @param int $id
	 * @return TimetableActiveRecord $active_record
	 *	A TimetableActiveRecord object
	 ...
	 *
	 * @return TimetableActiveRecord
	 * 	A single TimetableActiveRecord object
	 */
   ...
   */
    ...
    if ( ! empty( $errors ) ) {
      if ( $suppres_messages != TRUE ) TimetableHtml::show_wp_message( $errors );
      return FALSE;
    } elseif ( ! empty( $messages ) ) {
      if ( $suppres_messages != TRUE ) TimetableHtml::show_wp_message( $messages, 'updated' );
    }
