 ...
 */
?>
<table class="wp-list-table widefat timetable-item-table">
	<tr>
		<th class="check-column"></th>
		<th class="timetable-name-column"><?php _e('Name', 'weekly-class-schedule'); ?></th>
		<th class="timetable-description-column"><?php _e('Description', 'weekly-class-schedule'); ?></th>
		<th class='timetable-edit-column'></th>
	</tr>
	<?php if ( isset( $items ) && ! empty( $items ) ): ?>
		<?php foreach( $items as $item ): ?>
			<tr>
				...
				<?php endforeach; ?>
				<td><a href="<?php echo $edit_url; ?>&timetableid=<?php echo $item->id; ?>"><?php _e('Edit', 'weekly-class-schedule'); ?></a></td>
			</tr>
		<?php endforeach; ?>
	<?php endif; ?>
	<tr>
