<div class="wrap settings_wrap">
    ...
    <div class="title_line">
        ...
        if ($sliderTemplate) {
            ?>
            <div class="view_title"><i
                    class="revicon-pencil-1"></i><?php _e("New Slider Template", REVSLIDER_TEXTDOMAIN) ?></div>
        <?php
        } else {
            ?>
            <div class="view_title"><i class="revicon-pencil-1"></i><?php _e("New Slider", REVSLIDER_TEXTDOMAIN) ?>
            </div>
        <?php
        }
        ?>
        ...
        <div class="settings_panel_left">
            <div id="main_dlier_settings_wrapper" class="postbox unite-postbox ">
                ...
                <div class="p10">
                    ...
                    <div class="divide20"></div>
                    <a id="button_save_slider" class='button-primary revgreen' href='javascript:void(0)'><i
                            class="revicon-cog"></i><span
                            id="create_slider_text"><?php _e("Create Slider", REVSLIDER_TEXTDOMAIN) ?></span></a>

                    <span class="hor_sap"></span>
                    <a id="button_cancel_save_slider" class='button-primary revred'
