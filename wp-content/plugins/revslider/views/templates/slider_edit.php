...
<div class="wrap settings_wrap">
    ...
    <div class="title_line">
        ...
        <a href="<?php echo GlobalsRevSlider::LINK_HELP_SLIDER ?>" class="button-secondary float_right mtop_10 mleft_10"
            ...
            <div id="main_dlier_settings_wrapper" class="postbox unite-postbox ">
                ...
                <div class="p10">
                    ...
                    <div id="layout-preshow">
                        <strong>Layout
                            Example</strong><?php _e("(Can be different based on Theme Style)", REVSLIDER_TEXTDOMAIN) ?>
                    ...
                    <a class='button-primary revgreen' href='javascript:void(0)' id="button_save_slider"><i
                            class="revicon-cog"></i><?php _e("Save Settings", REVSLIDER_TEXTDOMAIN) ?></a>
                    <span id="loader_update" class="loader_round"
                          style="display:none;"><?php _e("updating...", REVSLIDER_TEXTDOMAIN) ?> </span>
                    <span id="update_slider_success" class="success_message"></span>
                    <a class='button-primary revred' id="button_delete_slider" href='javascript:void(0)'
                       id="button_delete_slider"><i
                            class="revicon-trash"></i><?php _e("Delete Slider", REVSLIDER_TEXTDOMAIN) ?></a>
                    <a class='button-primary revyellow' id="button_close_slider_edit"
                       href='<?php echo self::getViewUrl("sliders") ?>'><i
                            class="revicon-cancel"></i><?php _e("Close", REVSLIDER_TEXTDOMAIN) ?></a>
                    <a class="button-primary revblue" href="<?php echo $linksEditSlides ?>" id="link_edit_slides"><i
                            class="revicon-pencil-1"></i><?php _e("Edit Slides", REVSLIDER_TEXTDOMAIN) ?> </a>
                    <a class="button-primary revgray" href="javascript:void(0)" id="button_preview_slider"
                       title="<?php _e("Preview Slider", REVSLIDER_TEXTDOMAIN) ?>"><i
                            class="revicon-search-1"></i><?php _e("Preview", REVSLIDER_TEXTDOMAIN) ?></a>
