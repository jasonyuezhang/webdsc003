<div id="toolbox_wrapper" class="toolbox_wrapper postbox unite-postbox">
    <h3 class="box_closed tp-accordion tpa-closed">
        <div class="postbox-arrow"></div>
        <span><?php _e("Import / Export", REVSLIDER_TEXTDOMAIN) ?></span></h3>
    <div class="toggled-content tp-closedatstart p20">
        ...
        <div class="divide20"></div>
        <div
            class="api-desc"><?php _e("Note, that when you importing slider, it delete all the current slider settings and slides, then replace it with the new ones", REVSLIDER_TEXTDOMAIN) ?>
            .
        </div>
        <hr>
        <div class="divide20"></div>
        ...
        <a id="button_export_slider" class='button-primary revblue'
           href='javascript:void(0)'><?php _e("Export Slider", REVSLIDER_TEXTDOMAIN) ?></a>

        <div style="display: none;"><input type="checkbox"
                                           name="export_dummy_images"> <?php _e("Export with Dummy Images", REVSLIDER_TEXTDOMAIN) ?>
        </div>
        <!-- replace image url's -->
        ...
        <div
            class="api-desc"><?php _e("Replace all layer and background image url's. Example: http://localhost/ to http://yourwbsite.com/. <br> Note, the replace is not reversible", REVSLIDER_TEXTDOMAIN) ?>
            .
        </div>
        ...
        <a id="button_replace_url" class='button-primary revyellow'
           href='javascript:void(0)'><?php _e("Replace", REVSLIDER_TEXTDOMAIN) ?></a>

        <div id="loader_replace_url" class="loader_round"
             style="display:none;"><?php _e("Replacing...", REVSLIDER_TEXTDOMAIN) ?> </div>
