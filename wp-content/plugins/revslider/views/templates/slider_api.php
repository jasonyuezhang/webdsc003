...
<div id="api_wrapper" class="api_wrapper postbox unite-postbox ">
    <h3 class="box_closed tp-accordion tpa-closed">
        ...
        <span><?php _e("API Functions", REVSLIDER_TEXTDOMAIN) ?></span></h3>
    <div class="toggled-content tp-closedatstart p20">
        <div class="api-caption"><?php _e("API Methods", REVSLIDER_TEXTDOMAIN) ?>:</div>
        <div class="divide20"></div>
        <div
            class="api-desc"><?php _e("Please copy / paste those functions into your functions js file", REVSLIDER_TEXTDOMAIN) ?>
            .
        </div>
        ...
        <div class="divide20"></div>
        <div
            class="api-desc"><?php _e("Copy and Paste the Below listed API Functions into your jQuery Functions for Revslider Event Listening", REVSLIDER_TEXTDOMAIN) ?>
            .
        </div>
