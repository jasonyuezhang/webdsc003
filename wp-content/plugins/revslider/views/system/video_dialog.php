<!-- //Youtube dialog: -->
<div id="dialog_video" class="dialog-video" title="<?php _e("Add Video Layout", REVSLIDER_TEXTDOMAIN) ?>"
     style="display:none">
...
<div id="video_hidden_controls" style="display:none; margin-top:20px;">
    ...
    <div id="video_size_wrapper" class="youtube-inputs-wrapper">
        ...
        <div class="float_left mleft_20 mtop_10" id="input_video_width_lbl"><?php _e("Width", REVSLIDER_TEXTDOMAIN) ?>
            :
        </div>
        <input type="text" id="input_video_width" style="margin-top:5px;" class="video-input-small float_left"
               value="320">

        <div class="float_left mleft_20 mtop_10" id="input_video_height_lbl"><?php _e("Height", REVSLIDER_TEXTDOMAIN) ?>
            :
        </div>
        <input type="text" id="input_video_height" style="margin-top:5px;" class="video-input-small float_left"
               value="240">
    ...
    <div class="mtop_20">
        ...
        <div id="showautoplayfirsttime" class="float_left">
            ...
            <input type="checkbox" class="checkbox_video_dialog float_left mtop_13"
                   id="input_video_autoplay_first_time"></input>
        </div>
    ...
    <div class="video-title mtop_20" id="preview-image-video-wrap">
        ...
        <input type="button" id="" class="button-image-select-video button-primary revblue"
               value="<?php _e("Set", REVSLIDER_TEXTDOMAIN) ?>">
        <input type="button" id="" class="button-image-remove-video button-primary revblue"
               value="<?php _e("Remove", REVSLIDER_TEXTDOMAIN) ?>">
    ...
    <input type="text" id="input_video_arguments" style="width:100%;" value=""
           data-youtube="<?php echo GlobalsRevSlider::DEFAULT_YOUTUBE_ARGUMENTS ?>"
           data-vimeo="<?php echo GlobalsRevSlider::DEFAULT_VIMEO_ARGUMENTS ?>"></input>
    ...
    <div class="add-button-wrapper">
        <a href="javascript:void(0)" class="button-primary revblue" id="button-video-add"
           data-textadd="<?php _e("Add This Video", REVSLIDER_TEXTDOMAIN) ?>"
           data-textupdate="<?php _e("Update Video", REVSLIDER_TEXTDOMAIN) ?>"><?php _e("Add This Video", REVSLIDER_TEXTDOMAIN) ?></a>
    </div>
