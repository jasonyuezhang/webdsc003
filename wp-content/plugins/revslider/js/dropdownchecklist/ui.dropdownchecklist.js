...
(function ($) {
            ...
            var show = function (instance) {
                if (!instance.dropWrapper.isOpen) {
                    ...
                    if ((config.positionHow == null) || (config.positionHow == 'absolute')) {
                        ...
                        instance.dropWrapper.css({
                            position: 'absolute', top: instance.controlWrapper.position().top + instance.controlWrapper.outerHeight() + "px", left: instance.controlWrapper.position().left + "px"
                        });
    ...
    $.extend($.ui.dropdownchecklist, {
        defaults: {
            width: null, maxDropHeight: null, firstItemChecksAll: false, closeRadioOnClick: false, minWidth: 50, positionHow: 'absolute', bgiframe: false, explicitClose: null
        }
    });
