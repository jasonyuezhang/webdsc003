...
class UniteSettingsRevProductRev extends UniteSettingsOutputRev
{
    ...
    protected function drawTextInput($setting)
    {
        ...
        ?>
        <input type="text" <?php echo $class ?> <?php echo $style ?> <?php echo $disabled ?><?php echo $readonly ?>
    ...
    protected function drawImageInput($setting)
    {
        ...
        <input type="hidden" id="<?php echo $setting["id"] ?>" name="<?php echo $setting["name"] ?>"
               value="<?php echo $setting["value"] ?>"/>

        <input type="button" id="<?php echo $buttonID ?>"
               class='button-image-select button-primary revblue<?php echo $class ?>' value="Choose Image"></input>
    <?php
    }
    ...
    protected function drawColorPickerInput($setting)
    {
        ...
        ?>
        <input type="text" class="inputColorPicker" id="<?php echo $setting["id"] ?>" <?php echo $style ?>
               name="<?php echo $setting["name"] ?>" value="<?php echo $bgcolor ?>" <?php echo $disabled ?>></input>
    <?php
    }
    ...
    protected function drawDatePickerInput($setting)
    {
        ...
        ?>
        <input type="text" class="inputDatePicker" id="<?php echo $setting["id"] ?>"
               name="<?php echo $setting["name"] ?>" value="<?php echo $date ?>"></input>
    <?php
    }
    ...
    protected function drawTextAreaInput($setting)
    {
        ...
        <textarea id="<?php echo $setting["id"] ?>"
                  name="<?php echo $setting["name"] ?>" <?php echo $style ?> <?php echo $disabled ?> <?php echo $rows ?> <?php echo $cols ?>  ><?php echo $setting["value"] ?></textarea>
        <?php
        if (!empty($cols))
        ...
        <span id="<?php echo $wrapperID ?>" class="radio_settings_wrapper" <?php echo $addParams ?>>
            ...
            foreach ($items as $value => $text):
                ...
                <div class="radio_inner_wrapper">
                    <input type="radio" id="<?php echo $radioID ?>" value="<?php echo $value ?>"
                           name="<?php echo $setting["name"] ?>" <?php echo $checked ?>/>
    ...
    protected function drawCheckboxInput($setting)
    {
        ...
        ?>
        <input type="checkbox" id="<?php echo $setting["id"] ?>" class="inputCheckbox"
               name="<?php echo $setting["name"] ?>" <?php echo $checked ?>/>
    <?php
    }
    ...
    protected function drawSelectInput($setting)
    {
        ...
        <select id="<?php echo $setting["id"] ?>"
                name="<?php echo $setting["name"] ?>" <?php echo $disabled ?> <?php echo $class ?> <?php echo $args ?>>
            <?php
            foreach ($setting["items"] as $value => $text):
                ...
                ?>
                <option <?php echo $addition ?>
                    value="<?php echo $value ?>" <?php echo $selected ?>><?php echo $text ?></option>
            <?php
            endforeach
            ?>
        </select>
    ...
    protected function drawChecklistInput($setting)
    {
        ...
        ?>
        <select id="<?php echo $setting["id"] ?>" name="<?php echo $setting["name"] ?>" <?php echo $disabled ?>
                multiple <?php echo $class ?> <?php echo $args ?> size="1" style="<?php echo $style ?>">
            <?php
            foreach ($setting["items"] as $value => $text):
                //set selected
                $selected = "";
