...
class UniteSettingsProductSidebarRev extends UniteSettingsOutputRev
{
    ...
    protected function drawMultipleText($setting)
    {
        ...
        if (!empty($values) && is_array($values)) {
            foreach ($values as $key => $value) {
                ...
                <div class="fontinput_wrapper">
                    <input type="text" <?php echo $attribs ?> <?php echo $class ?> <?php echo $style ?> <?php echo $disabled ?> id="<?php echo $setting["id"] . '_' . $key ?>" name="<?php echo $setting["name"] ?>[]" value="<?php echo stripslashes($value) ?>"/>
                    <a href="javascript:void(0);" data-remove="<?php echo $setting["id"] . '_' . $key ?>" class="remove_multiple_text">
                        <i class="revicon-trash redicon withhover"></i>
                    </a>
                </div>
            <?php
            }
            ...
            ?>
            <div class="fontinput_wrapper">
                <input type="text" <?php echo $attribs ?> <?php echo $class ?> <?php echo $style ?> <?php echo $disabled ?> id="<?php echo $setting["id"] . '_' . $key ?>" name="<?php echo $setting["name"] ?>[]" value="<?php echo stripslashes($setting["value"]) ?>"/>
                <a href="javascript:void(0);" data-remove="<?php echo $setting["id"] . '_' . $key ?>" class="remove_multiple_text">
                    <i class="revicon-trash redicon withhover"></i>
                </a>
            </div>
        ...
        <div class="<?php echo $setting["id"] ?>_TEMPLATE" style="display: none;">
            <div class="fontinput_wrapper">
                <input type="text" <?php echo $attribs ?> <?php echo $class ?> <?php echo $style ?> id="##ID##" name="##NAME##[]" value=""/>
                <a href="javascript:void(0);" data-remove="##ID##" class="remove_multiple_text">
                    <i class="revicon-trash redicon withhover"></i>
                </a>
            </div>
        </div>
    ...
    public function drawCssEditor()
    {
        ...
        <ul class="list_idlehover">
            <li>
                <a href="javascript:void(0)" id="change-type-idle" class="change-type selected">
                    <span class="nowrap">Idle</span>
                </a>
            </li>
            <li>
                <a href="javascript:void(0)" id="change-type-hover" class="change-type">
                    <span class="nowrap">Hover</span>
                </a>
            </li>
            ...
            <div class="css_editor_novice_wrap">
                <table style="border-spacing:0px">
                    <tr class="css-edit-enable css-edit-title">
                        <td colspan="4">
                            <input class="css_edit_novice" type="checkbox" name="css_allow"/> <?php _e("enable ", REVSLIDER_TEXTDOMAIN) ?>
                            <span id="css_editor_allow"></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="font_family_down" class="ui-state-default ui-corner-all" style="margin-right:0px">
                        ...
                        <td>
                            <div class="sub_main_wrapper">
                                <div class="subslider_wrapper">
                                    <input class="css_edit_novice pad-input sub-input" type="text" name="css_padding[]" value=""/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="css_font-style" class="css_edit_novice"/>
                            <?php _e("italic", REVSLIDER_TEXTDOMAIN) ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" id="reset-border-color">
                                <i class="revicon-ccw editoricon" style="float:left"></i>
                            </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="sub_main_wrapper">
                                <div class="subslider_wrapper">
                                    <input class="css_edit_novice corn-input sub-input" type="text" name="css_border-radius[]" value=""/>
                                    <div class="subslider"></div>
                                </div>
                                <div class="subslider_wrapper">
                                    <input class="css_edit_novice corn-input sub-input" type="text" name="css_border-radius[]" value=""/>
        ...
        <div id="dialog-change-css-save-as" title="<?php _e("Save As", REVSLIDER_TEXTDOMAIN) ?>" style="display:none;">
            <p>
                <?php _e('Save as class:', REVSLIDER_TEXTDOMAIN) ?>
                <br/>
    ...
    public function drawGlobalCssEditor()
    {
        ...
        <div id="dialog-change-css-static" title="<?php _e("Save Static Styles", REVSLIDER_TEXTDOMAIN) ?>" style="display:none;">
            <p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 50px 0;"></span><?php _e('Overwrite current static styles?', REVSLIDER_TEXTDOMAIN) ?>
            </p>
        </div>
    <?php
    }
