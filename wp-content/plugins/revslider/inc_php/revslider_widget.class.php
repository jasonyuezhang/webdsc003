...
class RevSlider_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        if (empty($arrSliders))
            ...
            <input type="text" name="<?php echo $fieldTitle_Name ?>" id="<?php echo $fieldTitle_ID ?>"
            ...
            <input type="checkbox" name="<?php echo $fieldName_check ?>"
                   id="<?php echo $fieldID_check ?>" <?php echo $checked ?> >
            <br><br>
            <label
                for="<?php echo $fieldPages_ID ?>"><?php _e("Pages: (example: 2,10)", REVSLIDER_TEXTDOMAIN) ?></label>
            <input type="text" name="<?php echo $fieldPages_Name ?>" id="<?php echo $fieldPages_ID ?>"
