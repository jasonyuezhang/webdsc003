        ...
        <div class="box_content clear">
            ...
            if (isset($_GET['confirm'])):
                ...
                <span class="skl_pay_feat">
                    <?php echo sprintf(__('You are about to pay for the listing fee using your balance. <br/>The fee is <strong>%s</strong>. Your current credit amount is %s.', 'PricerrTheme'), PricerrTheme_get_show_price($prc), $cr); ?>
                </span>
                <br/><br/>
                <?php
