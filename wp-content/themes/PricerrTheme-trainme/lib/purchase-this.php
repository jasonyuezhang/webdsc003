            ...
            <div class="box_content clear">
                ...
                <div class="order_total">
                    <div class="padd10">
                        ...
                        <table width="100%">
                            <tr>
                                <td><?php _e('Lesson Base Price', 'PricerrTheme'); ?></td>
                            ...
                            <tr>
                                <td><strong><?php _e('Total Price to Pay', 'PricerrTheme'); ?></strong></td>
                                <td><strong><?php echo PricerrTheme_get_show_price($prc + $partial_ttl + $shipping); ?></strong>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                if ($PricerrTheme_paypal_enable == "yes"):
                    ...
                    ?>
                    <a class="feature_job" href="<?php bloginfo('siteurl'); ?>/?pay_for_item=paypal&jobid=<?php echo $pid; ?>&extras=<?php echo $extrs; ?>" class="post_bid_btn"><?php _e('Pay by PayPal', 'PricerrTheme'); ?></a> &nbsp;
                    <?php
                ...
                <?php if ($crds >= ($prc + $partial_ttl + $shipping)): ?>
                    <a class="deactivate_job" href="<?php bloginfo('siteurl'); ?>/?pay_for_item=credits&jobid=<?php echo $pid; ?>&extras=<?php echo $extrs; ?>" class="post_bid_btn"><?php _e('Pay with Balance', 'PricerrTheme'); ?></a> &nbsp;
                <?php endif; ?>
