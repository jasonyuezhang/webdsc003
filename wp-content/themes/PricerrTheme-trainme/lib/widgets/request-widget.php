...
class PricerrTheme_request_wdiget extends WP_Widget
{
    ...
    function PricerrTheme_request_wdiget()
    {
        ...
        $this->WP_Widget('request-widget', 'PricerrTheme - Request Lesson', $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        <div class="request_div_widget">
            <form method="post" action="<?php bloginfo('siteurl'); ?>/?jb_action=submit_request">
                ...
                <input type="submit" value="<?php _e("Suggest", "PricerrTheme"); ?>" name="submit_prepare_request"
                       id="suggest_job_btn" class="i_will_continue"/>
            </form>
        </div>


        <a href="<?php bloginfo('siteurl'); ?>/?post_type=request"><?php _e('See All Requests', 'PricerrTheme'); ?></a>
        <br/><br/>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <input type="text" id="<?php echo $this->get_field_id('nr_posts'); ?>"
                   name="<?php echo $this->get_field_name('nr_posts'); ?>"
