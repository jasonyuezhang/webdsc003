 ...
 */
class Who_Are_We_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'Who_Are_We_Widget', // Base ID
			'Fitness : Who Are We Widget', // Name
			array( 'description' => __( 'A widget displays who we are content with social networks', 'text_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'logoFooter' ); ?>"><?php _e('Title:', 'about_you'); ?></label>
			<input id="<?php echo $this->get_field_id( 'logoFooter' ); ?>" name="<?php echo $this->get_field_name( 'logoFooter' ); ?>" value="<?php echo $instance['logoFooter']; ?>" class="widefat" />
		</p>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Who_Are_We_Widget" );' ) );