...
class jobTheme_latest_posted_jobs extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        <?php else : ?> <?php $no_p = 1; ?>
            <div class="padd100"><p
                    class="center"><?php _e("Sorry, there are no posted lessons yet.", 'PricerrTheme'); ?></p></div>
    ...
    function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('show_jobs_limit'); ?>"><?php _e('Show jobs limit', 'PricerrTheme'); ?>
                :</label>
            <input type="text" id="<?php echo $this->get_field_id('show_jobs_limit'); ?>"
                   name="<?php echo $this->get_field_name('show_jobs_limit'); ?>"
