        ...
        <div class="padd10">
            ...
            <div class="box-content clear">
                ...
                if (isset($_POST['request_cancellation'])) //peace cancellation
                {
                    ...
                    echo '<input class="button btn-medium-large rounded grey" type="submit" value="' . __('Yes, Confirm Cancellation', 'PricerrTheme') . '" name="confirm_cancellation" />';
                    ...
                    echo '<form method="post">';
                    echo '<input class="button btn-medium-large rounded grey" type="submit" value="' . __('Yes, Confirm Cancellation', 'PricerrTheme') . '" name="confirm_force_cancellation" />';
                    echo '<input class="button btn-medium-large rounded grey" type="hidden" value="' . $orderid . '" name="orderid" />';
