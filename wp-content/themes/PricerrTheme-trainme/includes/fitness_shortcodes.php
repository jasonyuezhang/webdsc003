...
$choose_global_color = $options_theme['choose_global_color'];
    ...
    $html .= 'jQuery("#' . $unique_id .'").fitness_google_map({location: "' . $location . '", zoom:' . $zoom . '})';
    $html .= '}); </script>';
...
*******************************************************************************************************************/
    ...
    $html .= '<script type="text/javascript">jQuery(document).ready(function($){jQuery("#skills-graph-' . $rand . '").fitness_sliding_graph({speed: 1000});})</script> ';
...
*******************************************************************************************************************/
    ...
    $html .= "<script type='text/javascript'> jQuery(document).ready(function($) {";
    $html .= "jQuery('.grid').fitness_last_last_row();";
    $html .= "}) </script>";
   return $html;
}
