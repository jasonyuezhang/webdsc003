...
jQuery(document).ready(function($){  
	...
	jQuery("#td_icon_0 img").attr("src", value);
	...
	jQuery("#td_icon_1 img").attr("src", value);
	jQuery(field_id).change(function()
	{
	   value = "../" + jQuery(this).attr('value');
	   jQuery("#td_icon_1 img").attr("src", value);
	...
	jQuery("#td_icon_2 img").attr("src", value);
	jQuery(field_id).change(function()
	{
	   value = "../" + jQuery(this).attr('value');
	   jQuery("#td_icon_2 img").attr("src", value);
	...
	jQuery("#td_icon_3 img").attr("src", value);
	jQuery(field_id).change(function()
	{
	   value = "../" + jQuery(this).attr('value');
	   jQuery("#td_icon_3 img").attr("src", value);
...
<table id="shortcodes_<?php echo $name; ?>-table" class="form-table">
    ...
    <tr><?php $field_ = "Caption 1"; $field = "caption_0"; $default = "Icon Title"; $description = ""; ?>
    ...
    <tr><?php $field_ = "Icon 1"; $field = "icon_0"; $description = "Icon below the title"; ?>
        ...
        <td>
          ...
          <option value=""></option>
          <?php
          $icons_urls = glob("../images/icon-boxes/*.*");
          foreach ($icons_urls as $icon_url)
          {
              $icon_url = $root_.substr($icon_url, 2);
              $icon_url_ = substr($icon_url, strpos($icon_url, "/icon-boxes/") + 7);
          ?>
...
<div id="td_icon_0"><img src="" /></div>
    ...
    <tr><?php $field_ = "URL 1"; $field = "url_0"; $default = "http://www.jaredsdias.com"; $description = ""; ?>
        <th><label for="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>"><?php echo $field_; ?></label></th>
        <td><input style="width:400px" type="text" id="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>" name="<?php echo $field; ?>" value="<?php echo $default; ?>" /><br><br>
        <small><?php echo $description; ?></small>
        </td>         
    ...
    <tr><?php $field_ = "Caption 2"; $field = "caption_1"; $default = "Icon Title"; $description = ""; ?>
        <th><label for="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>"><?php echo $field_; ?></label></th>
        <td><input style="width:400px" type="text" id="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>" name="<?php echo $field; ?>" value="<?php echo $default; ?>" /><br><br>
        <small><?php echo $description; ?></small>
        </td>
...
<div id="td_icon_1"><img src="" /></div>
    ...
    <tr><?php $field_ = "URL 2"; $field = "url_1"; $default = "http://www.jaredsdias.com"; $description = ""; ?>
        <th><label for="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>"><?php echo $field_; ?></label></th>
        <td><input style="width:400px" type="text" id="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>" name="<?php echo $field; ?>" value="<?php echo $default; ?>" /><br><br>
        <small><?php echo $description; ?></small>
        </td>         
    ...
    <tr><?php $field_ = "Caption 3"; $field = "caption_2"; $default = "Icon Title"; $description = ""; ?>
        <th><label for="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>"><?php echo $field_; ?></label></th>
        <td><input style="width:400px" type="text" id="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>" name="<?php echo $field; ?>" value="<?php echo $default; ?>" /><br><br>
        <small><?php echo $description; ?></small>
        </td>
...
<div id="td_icon_2"><img src="" /></div>
    ...
    <tr><?php $field_ = "URL 3"; $field = "url_2"; $default = "http://www.jaredsdias.com"; $description = ""; ?>
        <th><label for="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>"><?php echo $field_; ?></label></th>
        <td><input style="width:400px" type="text" id="shortcodes_<?php echo $name; ?>-<?php echo $field; ?>" name="<?php echo $field; ?>" value="<?php echo $default; ?>" /><br><br>
        <small><?php echo $description; ?></small>
        </td>         
