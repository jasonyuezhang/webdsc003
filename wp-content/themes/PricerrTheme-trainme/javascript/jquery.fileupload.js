...
(function ($) {
    ...
    jQuery.widget('blueimp.fileupload', {
        ...
        _getFormData: function (options) {
            ...
            } else if (jQuery.isArray(options.formData)) {
        ...
        _onAdd: function (e, data) {
            ...
            if (options.singleFileUploads && this._isXHRUpload(options)) {
                jQuery.each(data.files, function (index, file) {
                    var newData = jQuery.extend({}, data, {files: [file]});
        ...
        _onChange: function (e) {
            var that = e.data.fileupload,
                data = {
                    files: jQuery.each(jQuery.makeArray(e.target.files), that._normalizeFile),
        ...
        _afterSetOption: function (key, value) {
            ...
            if (!options.fileInput) {
                options.fileInput = jQuery();
            }
            if (!options.dropZone) {
                options.dropZone = jQuery();
            }
