...
<?php if (have_posts()) while (have_posts()) :
                ...
                <div class="ad_page_content_stuff">
                    ...
                    <div class="job-page-details-holder">
                        <div class="job-page-date-holder">
                            <span><?php echo PricerrTheme_get_post_start_datetime(get_the_ID()) . " - " . PricerrTheme_get_post_end_datetime(get_the_ID()); ?></span>
                        </div>
                        <?php the_content(); ?>
        ...
        <div style="float:left;width:45%">
            <div class="box-title"><?php echo sprintf(__("Other groups by %s", 'PricerrTheme'), $author->user_login); ?></div>
            <div class="box_content clear">
                <?php
                $nrpostsPage = 8;
                $active = array(
