    ...
    for ($i = 1 ; $i <= 20 ; $i++)
        {
            ...
            if (class_exists('MultiPostThumbnails')  && MultiPostThumbnails::has_post_thumbnail('gallery_item', "extra-image-" . $i . "")) :
                ...
                $page_url = "gallery_item_extra-image-" . $i . "_url";
                $page_caption = "gallery_item_extra-image-" . $i . "_caption";  
                $page_description = "gallery_item_extra-image-" . $i . "_description";
        ...
        // get additional HTML
        $additional_HTML = get_post_meta($post->ID, "fitness_additional_content", true);
...
<div class="dynamic-content-wrapper">    
    ...
    <div class="section-title">    
        ...
        <div class="one-third last">
            ...
            <ul class="item-nav">
                <li class="prev"><?php //be_next_post_link("%link", "%title", true, "", 'gallery_category') ?></li>
                <li class="next"><?php //be_previous_post_link("%link", "%title", true, "", 'gallery_category') ?></li>
                <?php if (get_option($var_prefix."gallery_inline") == "yes") { ?><li class="all"><a href="#">All</a></li><?php } ?>
            </ul><!--END ITEM-NAV-->
...
<div id="gallery-item-wrapper">
        ...
        <div class="two-third">
            ...
            <div id="gallery" class="gallery-single slider">
            ...
            </div><!--END GALLERY GALLERY-SINGLE SLIDER-->
...
$include_file = "gallery_section.inc.php";
    //if (get_option($var_prefix."gallery_behaviour") == "no_hover") $include_file = "gallery_section_no_hover.inc.php";
    //if (get_option($var_prefix."gallery_behaviour") == "no_hover_preview") $include_file = "gallery_section_no_hover_preview.inc.php";
    //if (get_option($var_prefix."gallery_behaviour") == "no_hover_with_icons") $include_file = "gallery_section_no_hover_with_icons.inc.php"; 
