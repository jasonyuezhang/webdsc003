...
<?php if (have_posts()) {
        while (have_posts()) : the_post();
            ...
            if ($active == 0) {
                echo '<h4>';
                _e('This group has been disabled.', 'PricerrTheme');
                echo '</h4>';
            } else {
                    ...
                    <div class="ad_page_title">
                        <div class="image_and_user">
                            <img width="25" height="25" border="0" src="<?php
                                echo PricerrTheme_get_avatar($author);

                                $author_data = get_userdata($author);
                                    ?>"/>
                            <a href="<?php echo PricerrTheme_get_user_profile_link($author_data->user_login); ?>"><?php echo $author_data->user_login; ?></a>
                            <span>:</span>
                        </div>
                        <h1><?php the_title(); ?></h1>
                    </div>
                ...
                <div class="job_info_stuff">
                    <div class="padd5-medal">
                        ...
                        <!--<div class="deli_days"><?php echo $orders_in_queue ?></div>-->
                        <!--<div class="separator_job_rating"></div>-->

                        <div class="job_rating"> <?php _e("SELLER RATING", "PricerrTheme"); ?>:</div>
                        <div class="rating_100"><?php echo PricerrTheme_get_avg_trainer_rating($post->post_author); ?>%</div>
            ...
            <?php if ($featured == "1"): ?>
                    ...
                    <div class="job-page-details-holder">
                        <div class="job-page-details-wrapper">
                            <!-- Custom start and end date fields added by Carroll Yu -->
                            <div class="job-page-detail">
                                <span><?php echo "<strong>Start Time:</strong>\t" . PricerrTheme_get_post_start_datetime(get_the_ID()); ?></span>
                            </div>
                            <div class="job-page-detail">
                                <span><?php echo "<strong>End Time:</strong>\t" . PricerrTheme_get_post_end_datetime(get_the_ID()); ?></span>
                            </div>
                            <div class="job-page-detail">
                            ...
                            <div class="job-page-detail the-tags"><?php the_tags(__('<strong>Tags:</strong> ', 'PricerrTheme') . "", '  ', '  '); ?> </div>
            ...
            ?>
                ...
                <div class="job_info_stuff2">
                    <div class="padd5">
                        ...
                        <div class="job_rating4"><?php
                            ...
                            echo sprintf(__("created %s ago", "PricerrTheme"), PricerrTheme_prepare_seconds_to_words($sc));
                            ?></div>
                        <div class="separator_job_rating2"></div>

                        <div class="job_rating4"><?php echo sprintf(__("%s ratings for group", "PricerrTheme"), $total_ratings_pid); ?></div>
                        <!--<div class="separator_job_rating2"></div>-->
                        <!--<div class="job_rating4"><?php printf(__("%s likes for this group", "PricerrTheme"), $likes); ?></div>-->
                        <!--<div class="separator_job_rating2"></div>-->
                        ...
                        <!--<div class="job_rating4 like-stuff" id="lk-stuff<?php the_ID(); ?>">
                            ...
                            if (!is_user_logged_in()) {
                                ?><a href="<?php PricerrTheme_login_url_with_redirect(); ?>" class="like_this_job_no_logged" rel="<?php the_ID(); ?>"><?php _e("Like this Lesson", "PricerrTheme"); ?></a><?php
                            } else {

                                if (count($r) == 0):
                                    ?>
                                    <a href="#" class="like_this_job" rel="<?php the_ID(); ?>"><?php _e("Like this Lesson", "PricerrTheme"); ?></a>
                                <?php else: ?>
                                    <a href="#" class="unlike_this_job" rel="<?php the_ID(); ?>"><?php _e("Unlike this Lesson", "PricerrTheme"); ?></a>
                                <?php
                                endif;
                            } */
                            ?>
                ...
                <div class="clear10"></div>
                <div class="box-title"><?php echo __("Group Description", 'PricerrTheme'); ?></div>
                <div class="box_content"><?php the_content(); ?></div>

                <div class="clear10"></div>
                <div class="box-title"><?php echo __("Group Videos", 'PricerrTheme'); ?></div>
                <div class="box_content"><?php
                   ...
                   if ($vid == 0)
                       _e('No videos attached with this group.', 'PricerrTheme');
                            ?></div>
                ...
                <div class="box_content clear"><?php
                    ...
                    if (count($r) > 0) {
                        ...
                        foreach ($r as $row) {
                            ...
                            _e("The group doesn't have feedback yet.", "PricerrTheme");
                        }
                        ?><div class="clear10"></div>

                    <div style="float:left;width:45%">
                        <div class="box-title"><?php echo sprintf(__("Other groups by %s", 'PricerrTheme'), $author_data->user_login); ?></div>
                        <div class="box_content clear"><?php
                            $nrpostsPage = 8;
                            $active = array(
                                'key' => 'active',
                            ...
                            if ($the_query->have_posts()):
                                ...
                                echo __('No other groups posted.', "PricerrTheme");
                            endif;
                            // Reset Post Data
                            wp_reset_postdata();
                        ?></div>
                    ...
                    <div style="float:right;width:45%">
                        <div class="box-title"><?php _e("Related groups", 'PricerrTheme'); ?></div>
                ...
                ?>
                    <form method="get" name="myFormPurchase" class="fltRight" action="<?php echo $act; ?>">
                        ...
                        <?php } elseif ($orders_in_queue >= $total_space) { ?>
                            <a href="#" onclick="return false;" class="purchase_disable_btn"><?php _e("Group Is Full", "PricerrTheme"); ?></a>
                        <?php } else {
                                    ...
                                    <ul class="purchase_extra_ul">
                                        ...
                                        foreach ($extra_job_add as $extra_job_add_item):
                                            ...
                                            echo '<li><input type="checkbox" name="extra' . $extra_job_add_item['extra_nr'] . '" value="1" />' .
                                                __('I will', 'PricerrTheme') . ' ' . $extra_job_add_item['content'] . ' ' . __('for', 'PricerrTheme') .
                            ...
                            ?><a href="#" onclick="document.myFormPurchase.submit(); return false;" class="purchase_now_btn"><?php _e("Group Me For ", "PricerrTheme"); ?><?php echo intval(substr(PricerrTheme_get_show_price($prc),1,-1)) == 0 ? "Free" : PricerrTheme_get_show_price($prc); ?></a>
                        <?php }
                        ...
                        <p class="contact-seller-wrap"><a href="<?php echo $privurl_m; ?>priv_act=send&pid=<?php the_ID(); ?>&uid=<?php echo $author_data->ID; ?>" class="contact-seller-thing"><?php _e("Contact Seller", "PricerrTheme"); ?></a></p>
                    </form>
                </div><?php
                    endif;
