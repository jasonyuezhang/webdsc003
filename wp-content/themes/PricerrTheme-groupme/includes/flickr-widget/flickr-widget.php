<?php
/**
 * Plugin Name: Fitness Flickr Widget
...
class DP_Flickr_Widget extends WP_Widget {
	...
	function DP_Flickr_Widget() {
		$this->prefix = 'fitness';
		$this->textdomain = 'fitness-flickr-widget';
		...
		$this->WP_Widget("{$this->prefix}-flickr-widget", __('Fitness : Flickr', $this->textdomain), $widget_ops); 
