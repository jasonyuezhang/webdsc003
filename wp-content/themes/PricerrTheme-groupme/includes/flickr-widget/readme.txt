...
1. Upload the entire folder `liber-flickr-widget` to `/wp-content/plugins/`
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Add the widget 'Liber Flickr' to your sidebar from Appearance->Widgets and configure the widget options.
