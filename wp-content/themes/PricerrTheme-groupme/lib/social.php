...
function PricerrTheme_display_social_login()
{
    ...
    if ($PricerrTheme_enable_facebook_login == "yes") : ?>
        <a href="javascript:void(0);" title="Facebook" class="social_connect_login_facebook"><img alt="Facebook"
                                                                                                  src="<?php echo $images_url . 'facebook_32.png' ?>"/></a>
    <?php endif; ?>
    <?php if ($PricerrTheme_enable_twitter_login == "yes") : ?>
    <a href="javascript:void(0);" title="Twitter" class="social_connect_login_twitter"><img alt="Twitter"
