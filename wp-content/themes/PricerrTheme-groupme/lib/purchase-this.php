...
{
    return __("Purchase job", 'PricerrTheme') . " - ";
}

add_filter('wp_title', 'PricerrTheme_filter_ttl', 10, 3);

if (!is_user_logged_in()) {
    wp_redirect(get_bloginfo('siteurl') . "/wp-login.php?redirect_to=" . get_permalink($pid));
    exit;
}
            ...
            <div class="box_content clear">
                ...
                <div class="order_total">
                    <div class="padd10">
                        ...
                        <table width="100%">
                            <tr>
                                <td><?php _e('Group Base Price', 'PricerrTheme'); ?></td>
                            ...
                            <tr>
                                ...
                                <td><b><?php echo PricerrTheme_get_show_price($prc + $partial_ttl + $shipping); ?></b>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                if ($PricerrTheme_paypal_enable == "yes"):
                    ...
                    ?>
                    <a href="<?php bloginfo('siteurl'); ?>/?pay_for_item=paypal&jobid=<?php echo $pid; ?>&extras=<?php echo $extrs; ?>"
                       class="post_bid_btn"><?php _e('Pay by PayPal', 'PricerrTheme'); ?></a> &nbsp;
                ...
                if ($PricerrTheme_moneybookers_enable == "yes"):
                    ?>
                    <a href="<?php bloginfo('siteurl'); ?>/?pay_for_item=moneybookers&jobid=<?php echo $pid; ?>&extras=<?php echo $extrs; ?>"
                       class="post_bid_btn"><?php _e('Pay by Moneybookers', 'PricerrTheme'); ?></a> &nbsp;
                ...
                if ($PricerrTheme_alertpay_enable == "yes"):
                    ?>
                    <a href="<?php bloginfo('siteurl'); ?>/?pay_for_item=payza&jobid=<?php echo $pid; ?>&extras=<?php echo $extrs; ?>"
                       class="post_bid_btn"><?php _e('Pay by Payza', 'PricerrTheme'); ?></a> &nbsp;
                ...
                if ($PricerrTheme_bank_enable == "yes"):
                    ?>
                    <a href="<?php bloginfo('siteurl'); ?>/?pay_for_item=bank&jobid=<?php echo $pid; ?>&extras=<?php echo $extrs; ?>"
                       class="post_bid_btn"><?php _e('Pay by Bank(Offline)', 'PricerrTheme'); ?></a> &nbsp;
