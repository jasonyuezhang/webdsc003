...
function PricerrTheme_render_login_page_uri()
{
    ?>
    <input type="hidden" id="social_connect_login_form_uri"
           value="<?php echo site_url('wp-login.php', 'login_post'); ?>"/>
<?php
}
...
function PricerrTheme_display_social_login()
{
    ...
    if ($PricerrTheme_enable_facebook_login == "yes" or $PricerrTheme_enable_twitter_login == "yes"):
        ?>

        <p>
            <label><?php _e('Connect with:', 'PricerrTheme'); ?></label>


            <?php

            if ($PricerrTheme_enable_facebook_login == "yes") : ?>
                <a href="#" title="Facebook" class="social_connect_login_facebook "><img class="sclk" alt="Facebook"
                                                                                         src="<?php echo $images_url . 'facebook_32.png' ?>"/></a>
            <?php endif; ?>
            <?php if ($PricerrTheme_enable_twitter_login == "yes") : ?>
                <a href="#" title="Twitter" class="social_connect_login_twitter "><img class="sclk" alt="Twitter"
                                                                                       src="<?php echo $images_url . 'twitter_32.png' ?>"/></a>
            <?php endif;
        ...
        <div id="social_connect_facebook_auth">
            <input type="hidden" name="client_id" value="<?php echo get_option('PricerrTheme_facebook_app_id'); ?>"/>
            <input type="hidden" name="redirect_uri"
                   value="<?php echo urlencode(get_bloginfo('template_url') . '/lib/social/facebook/callback.php'); ?>"/>
        </div>
        <div id="social_connect_twitter_auth"><input type="hidden" name="redirect_uri"
                                                     value="<?php echo(get_bloginfo('template_url') . '/lib/social/twitter/connect.php'); ?>"/>
        </div>
...
add_action('login_form_social_connect', 'PricerrTheme_social_connect_process_login');
add_action('register_form_social_connect', 'PricerrTheme_social_connect_process_login');
add_filter('login_form', 'PricerrTheme_display_social_login');
add_action('wp_footer', 'PricerrTheme_render_login_page_uri');
add_filter('register_form', 'PricerrTheme_display_social_login');
