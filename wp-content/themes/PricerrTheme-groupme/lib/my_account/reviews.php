                ...
                <script>
                    jQuery(document).ready(function () {
                        jQuery('.dd-submit-rating').click(function () {
                            ...
                            if (reason.length < 10) {
                                alert("<?php _e('Please input a longer description for your rating','PricerrTheme'); ?>");
                                return false;
                            }
                            jQuery.ajax({
                                type: "POST",
                        ...
                        <div class="post" id="post-<?php echo $row->ratid; ?>">
                            <div class="padd10_only">
                                ...
                                <div class="title_holder3">
                                    ...
                                    <div class="c111">
                                        <textarea id="reason-<?php echo $row->ratid; ?>" rows="2" cols="35"></textarea>
                                    </div>
                                    <div class="c111">
                                        <select name="rating_me" id="rating_me-<?php echo $row->ratid; ?>">
