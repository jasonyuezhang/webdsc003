    ...
    <div id="tabs1" style="display: block; ">
        ...
        <table width="100%" class="sitemile-table">
            ...
            <tr>
                ...
                <td><a class="festin" href="http://sitemile.com/p/pricerr">Pricerr Micro-Group Theme</a></td>
            </tr>
...
<div id="usual2" class="usual">
    <ul>
        ...
        <li><a href="#tabs2"><?php _e('Group Page', 'PricerrTheme'); ?></a></li>
...
<div id="usual2" class="usual">
    ...
    <div id="tabs1">
        ...
        -->
                ...
                <tr>
                    <td valign=top><?php PricerrTheme_theme_bullet('Leave the box empty to have default value (Post New Group Link)'); ?></td>
        ...
        if (count($r) > 0):
            ...
            <table class="widefat post fixed" cellspacing="0">
                ...
                <tr>
                    ...
                    <th><?php _e('Group Owner', 'PricerrTheme'); ?></th>
                    <th width="20%"><?php _e('Group Name', 'PricerrTheme'); ?></th>
    ...
    <div id="tabs2">
        ...
        if (count($r) > 0):
            ...
            <table class="widefat post fixed" cellspacing="0">
                ...
                <tr>
                    <th><?php _e('User', 'PricerrTheme'); ?></th>
                    <th><?php _e('Group', 'PricerrTheme'); ?></th>
                    <th><?php _e('Price', 'PricerrTheme'); ?></th>
                    <th><?php _e('Rating Type', 'PricerrTheme'); ?></th>
                    <th><?php _e('Description', 'PricerrTheme'); ?></th>
                    <th><?php _e('Awarded On', 'PricerrTheme'); ?></th>
...
<div id="usual2" class="usual">
    ...
    <div id="tabs1">
        ...
        if (count($r) > 0) {
            ...
            echo '<th width="30%">' . __('Group Name', 'PricerrTheme') . '</th>';
    ...
    <div id="tabs2">
        ...
        if (count($r) > 0) {
            ...
            echo '<th width="5%">' . __('ID', 'PricerrTheme') . '</th>';
            echo '<th width="30%">' . __('Group Name', 'PricerrTheme') . '</th>';
            echo '<th>' . __('Group Price', 'PricerrTheme') . '</th>';
            echo '<th>' . __('Seller', 'PricerrTheme') . '</th>';
            echo '<th>' . __('Buyer', 'PricerrTheme') . '</th>';
            echo '<th>' . __('Ordered on', 'PricerrTheme') . '</th>';
            echo '<th>' . __('Days to Finish', 'PricerrTheme') . '</th>';
...
<div id="usual2" class="usual">
    ...
    <tr>
        <td valign=top width="22"><?php PricerrTheme_theme_bullet(); ?></td>
        <td><?php _e('Number of Homepage Groups:', 'PricerrTheme'); ?></td>
        <td>
    ...
    <tr>
        ...
        <td><?php _e('Group listing period:', 'PricerrTheme'); ?>
        </td>
        <td>
    ...
    <tr>
        ...
        <td width="240">
            <?php _e('Translation for "I will":', 'PricerrTheme'); ?>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <?php _e('Slug for Groups Permalink:', 'PricerrTheme'); ?>
        </td>
        <td>
...
function PricerrTheme_email_settings()
{
    ...
    <ul>
        ...
        <li><a href="#tabs3"><?php _e('Post Group Approved Email (admin)', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs_gop"><?php _e('Post Group Not-approved Email (admin)', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs_gas"><?php _e('Post Group Approved Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs_kli"><?php _e('Post Group Not Approved Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs4"><?php _e('Seller Group Purchase Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs5"><?php _e('Buyer Group Purchase Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs6"><?php _e('Private Message Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs7"><?php _e('New Chat Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs8"><?php _e('Group Delivered Email', 'PricerrTheme'); ?></a></li>
        <li><a href="#tabs9"><?php _e('Group Completed Email', 'PricerrTheme'); ?></a></li>
        ...
        <form method="post"
            ...
            <table width="100%" class="sitemile-table">
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" name="PricerrTheme_save_request"
                               value="<?php _e('Save Options', 'PricerrTheme'); ?>"/></td>
                </tr>
...
<div id="tabs3">
    ...
    <form method="post" action="<?php echo get_bloginfo('siteurl'); ?>/wp-admin/admin.php?page=pricing-settings&active_tab=tabs3">
        <table width="100%" class="sitemile-table">
            ...
            <tr>
                <td valign=top width="22"><?php PricerrTheme_theme_bullet(); ?></td>
                <td width="160"><?php _e('Group fixed amount:', 'PricerrTheme'); ?></td>
                <td>
