                ...
                <div class="my_box3">
                    <div class="padd10">
                        <div class="content-wrapper-narrow">
                            <div class="box-title"><?php _e("Retrieve Password", $current_theme_locale_name); ?></div>
                                ...
                                <div class="box_content">
                                    ...
                                    <div class="login-submit-form">
                                        ...
                                        <ul id="logins">
                                            ...
                                            <li>
                                                <div>
                                                    <a href="<?php bloginfo('wpurl'); ?>/wp-login.php?action=lostpassword" title="<?php _e('Password Lost and Found', $current_theme_locale_name) ?>"><?php _e('FORGOT PASSWORD', $current_theme_locale_name) ?></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
