                    ...
                    <div class="my_box3">
                        <div class="padd10">
                            <div class="content-wrapper-narrow">
                                ...
                                <div class="register-conform-content">
                                    <div class="register-info">
                                        <?php printf(__('<div class="label pright0 col-sm-5">Username:</div><div class="confirm-info col-sm-7">%s</div>', $current_theme_locale_name), "<strong>" . esc_html($user_login) . "</strong>") ?>
                                    </div>
                                    <div class="register-info">
                                        <?php printf(__('<div class="label pright0 col-sm-5">Password:</div><div class="confirm-info col-sm-7">%s</div>', $current_theme_locale_name), '<strong>' . __('emailed to you', $current_theme_locale_name) . '</strong>') ?>
                                    </div>
                                    <div class="register-info">
                                        <?php printf(__('<div class="label pright0 col-sm-5">E-mail:</div><div class="confirm-info col-sm-7">%s</div>', $current_theme_locale_name), "<strong>" . esc_html($user_email) . "</strong>") ?>
                                    </div>
                                    ...
                                    <div class="login-submit-form">
                                        <form method="post" id="register-form" enctype="multipart/form-data">
                                            ...
                                            <div class="register-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="do_input register-textbox" name="user_paypal_email" id="user_paypal_email" size="34" value="<?php echo esc_html($user_paypal_email); ?>" placeholder="Not Required"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="register-group">
                                                <br>
                                                <p class="agree-terms">By Clicking “Sign Up” below, you are agreeing to the Uber Terms and Conditions and Privacy Policy</p>
                                            </div>
                                            <div class="register-group">
