...
{
    return __("Dectivate job", 'PricerrTheme') . " - ";
}
...
?>
    ...
    <div id="content-side-bar">
        <div class="padd10">
            ...
            <div class="box-title"><?php echo sprintf(__("Deactivate Group - %s", 'PricerrTheme'), $title); ?></div>
            <div class="box_content clear">
                ...
                if (isset($_POST['are_you_sure2'])) {
                    ...
                    <form method="post" enctype="application/x-www-form-urlencoded">
                        ...
                        <input class="button btn-medium-large rounded grey" type="submit" name="are_you_sure2" value="<?php _e("Confirm Deactivation", 'PricerrTheme'); ?>"/>
                    </form>
