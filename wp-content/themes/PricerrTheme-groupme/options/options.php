...
class NHP_Options{
	...
	*/
	function _enqueue(){
		...
		wp_enqueue_script(
			'nhp-opts-js', 
			$this->url.'javascript/options.js',
			array('jquery'),
			time(),
			true
		);
	...
	*/
	function _options_page_html(){
		...
		echo '<div class="wrap">';
		echo '<h2 id="nhp-opts-heading"></h2>';
			...
			?>
			  ...
			  js.src = "//connect.facebook.net/pt_BR/all.js#xfbml=1&appId=122702031273057";
			...
			echo '<div id="nhp-opts-header" style="background-color:#272b2f;">';
			echo '<h2><a href="https://twitter.com/8grids" class="twitter-follow-button" data-show-count="true" data-lang="en">Follow @8grids</a>';
			echo '<div class="fb-like" data-href="http://facebook.com/8grids" data-send="true" data-width="500" data-colorscheme="dark" data-show-faces="false"></div></h2>';
			echo '<div style="text-align:right;">'; 
			echo '<a style="font-size: 12px; text-decoration: none; color: #FFF;" href="http://8grids.com/store"><img src="' . get_template_directory_uri() . '/options/img/themes.png" />  MORE THEMES</a>';
			echo ' &nbsp; &nbsp; ';
			echo '<a style="font-size: 12px; text-decoration: none; color: #FFF;" href="http://8grids.com/support"><img src="' . get_template_directory_uri() . '/options/img/support.png" />  SUPPORT</a>';
			echo'</div>';
            echo '<div class="clear"></div><!--clearfix-->';
            echo '</div>';
