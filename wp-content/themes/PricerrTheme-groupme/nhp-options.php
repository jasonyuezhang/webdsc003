...
$sections[] = array(
				...
				array(
						...
						'desc' => __('Click Browse and upload your image, and then click <b>Insert into Post</b>. .PNG and .JPG allowed. You can find more patterns at <a href="http://subtlepatterns.com/" target="_blank">SubtlePatterns.com</a>.', 'nhp-opts'),
						'std' => ''
						),
				array(
						'id' => 'tile_image',
